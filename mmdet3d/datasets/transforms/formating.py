...
class Pack3DDetInputs(BaseTransform):
    INPUTS_KEYS = ['points', 'img','sam_feat','sam_freq_feat']
    ...
    def __init__(
        ...
        all_keys = tuple(set(keys) | set(self.INPUTS_KEYS))
        self.keys = all_keys
    ...
    def pack_single_results(self, results: dict) -> dict:
        ...
        if 'img' in results:
            if isinstance(results['img'], list):
                ...
                results['img'] = img
        if 'sam_feat' in results:
            results['sam_feat'] = to_tensor(results['sam_feat'])
        if'sam_freq_feat' in results:
            results['sam_freq_feat'] = to_tensor(results['sam_freq_feat'])
        ...
        for key in self.keys:
            # print(self.keys),"ssssssssssssssssssssssssssssssssssssssss"
        ...
        # print("packed_results keys:", packed_results.keys())  # 验证！
        # print(packed_results['inputs'].keys(),"uuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuuu")
